...
@Component({
  ...
  templateUrl: './facebook-form.page.html',
  styleUrls: ['./facebook-form.page.scss'],
})
export class FacebookFormPage implements OnInit {

  register:boolean;
  email:string;//sing in / register
  phone: string;// sing in / register
  ...
  ngOnInit() {
    ...
    console.log('transition working')
     ...
     async notVerified(){
      ...
      signUpUser(){
       if(this.name==null ||this.lastName==null || this.email==null || this.zipCode==null){
          this.notVerified();
       }else{
